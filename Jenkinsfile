...
"""
                    ...
                    sh 'ssh -i /var/test.pem -o StrictHostKeyChecking=no ubuntu@13.234.32.204 "kubectl apply -f -" < deployment.yaml'
                    sh 'ssh -i /var/test.pem -o StrictHostKeyChecking=no ubuntu@13.234.32.204 "kubectl apply -f -" < service.yaml'
                }
            }
        }
    }
